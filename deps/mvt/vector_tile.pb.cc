...
// optional bytes raster = 5;
bool Tile_Feature::has_raster() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
void Tile_Feature::set_has_raster() {
  _has_bits_[0] |= 0x00000010u;
}
void Tile_Feature::clear_has_raster() {
  _has_bits_[0] &= ~0x00000010u;
}
void Tile_Feature::clear_raster() {
  raster_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_raster();
}
 const ::std::string& Tile_Feature::raster() const {
 ...
 void Tile_Feature::set_raster(const ::std::string& value) {
  set_has_raster();
 ...
 void Tile_Feature::set_raster(const char* value) {
  set_has_raster();
 ...
 void Tile_Feature::set_raster(const void* value, size_t size) {
  set_has_raster();
 ...
 ::std::string* Tile_Feature::mutable_raster() {
  set_has_raster();
 ...
 ::std::string* Tile_Feature::release_raster() {
  // @@protoc_insertion_point(field_release:vector_tile.Tile.Feature.raster)
  clear_has_raster();
  return raster_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void Tile_Feature::set_allocated_raster(::std::string* raster) {
  if (raster != NULL) {
    set_has_raster();
  } else {
    clear_has_raster();
